...
## Práctica 6 — Servicio UDP de la Capa de Transporte
### Objetivo
Implementar un **servicio UDP** utilizando **Node.js** para comprender el funcionamiento del protocolo en la capa de transporte, desarrollando un sistema cliente-servidor capaz de enviar y recibir mensajes en tiempo real, y analizando su comportamiento mediante la herramienta **Wireshark**.
